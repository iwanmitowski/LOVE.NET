        ...
        <div>
          <div style={{ overflow: "scroll", height: "30vh" }}>
            ...
            <p>
              ...
              the use of LOVE.NET's Website, located at love.net.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use love.net if you do not agree to
            ...
            <p>
              We employ the use of cookies. By accessing love.net, you agreed to
              use cookies in agreement with the LOVE.NET's Privacy Policy.{" "}
            </p>
            ...
            <p>
              Unless otherwise stated, LOVE.NET and/or its licensors own the
              intellectual property rights for all material on love.net. All
              intellectual property rights are reserved. You may access this
              from love.net for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from love.net</li>
              <li>Sell, rent or sub-license material from love.net</li>
              <li>Reproduce, duplicate or copy material from love.net</li>
              <li>Redistribute content from love.net</li>
            </ul>
            ...
            <p>
              ...
              LOVE.NET does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of LOVE.NET,its agents and/or affiliates.
              ...
              laws, LOVE.NET shall not be liable for the Comments or for any
            ...
            <p>
              LOVE.NET reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant LOVE.NET a non-exclusive license to use,
            ...
            <p>
              ...
              LOVE.NET; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to LOVE.NET. Please include your name, your
            ...
            <p>
              No use of LOVE.NET's logo or other artwork will be allowed for
